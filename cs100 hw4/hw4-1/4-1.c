	...
	if (bomb != 0 && trio == 0) {
		if (bomb == 1) {
			if (res == 0) {
				...
				if ((solo==4) || (solo==3&&joker==1) || (pair==1&&joker==2)) {
					step = 3;
				}
				else if (pair == 2) {
					step = 1;
				...
				else if ((solo==1&&pair==3) || (solo==1&&joker==2&&pair==2) || (pair==2&&joker==1)) {
					step = 3;
				}
				else {
					step = 4;
				...
				else if ((solo==4&&pair==2) || (solo==4&&joker==2&&pair==1) || (solo==3&&joker==1&&pair==2)) {
					step = 5;
				}
				...
				if ((solo == 11) || (solo == 10 && joker == 1)) {
					step = 10;
				}
				else if ((solo == 9 && pair == 1) || (solo == 9 && joker == 2) || (solo == 8 && pair == 1 && joker == 1)) {
					step = 9;
				}
				else if ((solo==7&&pair==2) || (solo==7&&pair==1&&joker==2) || (solo==6&&pair==2&&joker==1)) {
					step = 8;
				}
				else if ((solo==3&&pair==4) || (solo==3&&pair==3&&joker==2)) {
					step = 6;
				}
				else if ((solo==1&&pair==5) || (solo==1&&pair==4&&joker==2)||(pair==5&&joker==1)) {
					step = 5;
				}
				else {
					step = 7;
				...
				if ((solo==12) || (solo==11&&joker==1)) {
					step = 11;
				}
				else if ((solo==10&&pair==1) || (solo==10&&joker==2) || (solo==9&&pair==1&&joker==1)) {
					step = 10;
				}
				else if ((solo==8&&pair==2) || (solo==8&&pair==1&&joker==2) || (solo==7&&pair==2&&joker==1)) {
					step = 9;
				}
				else if ((solo==6&&pair==3) || (solo==6&&pair==2&&joker==2) || (solo==5&&pair==3&&joker==1)) {
					step = 8;
				}
				else if ((solo==4&&pair==4) || (solo==4&&pair==3&&joker==2) || (solo==3&&pair==4&&joker==1)) {
					step = 7;
				}
				else if ((pair==6) || (pair==5&&joker==2)) {
					step = 5;
				}
				else {
					step = 6;
				...
				if ((solo==13) || (solo==12&&joker==1)) {
					step = 12;
				}
				else if ((solo==11&&pair==1) || (solo==11&&joker==2) || (solo==10&&pair==1&&joker==1)) {
					step = 11;
				}
				else if ((solo==9&&pair==2) || (solo==9&&pair==1&&joker==2) || (solo==8&&pair==2&&joker==1)) {
					step = 10;
				}
				else if ((solo==7&&pair==3) || (solo==7&&pair==2&&joker==2) || (solo==6&&pair==3&&joker==1)) {
					step = 9;
				}
				else if ((solo==5&&pair==4) || (solo==5&&pair==4&&joker==2) || (solo==4&&pair==4&&joker==1)) {
					step = 8;
				}
				else if ((solo==3&&pair==5) || (solo==3&&pair==4&&joker==2) || (solo==2&&pair==5&&joker==1)) {
					step = 7;
				}
				else {
					step = 6;
			...
			if (res == 5) {
				if ((solo == 5) || (solo == 4 && joker == 1) || (solo == 3 && joker == 2) || (solo == 1 && joker == 2 && pair == 1)) {
					step = 4;
				}
				else {
					step = 3;
